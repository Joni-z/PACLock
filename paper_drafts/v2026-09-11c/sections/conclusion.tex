...
establish is how much of that gain is the cross-frequency alignment
rather than the explicit envelope the interaction rows also carry, nor
the physiological reading of the statistic the token carries: the coupling is measured at patch resolution over learned bands,
