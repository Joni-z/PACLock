...
\item \textbf{A small encoder built around it, with the attribution that
  ...
  (Section~\ref{sec:attribution}); this attributes the gain to the
  interaction rows as a whole, and the controls that would split it
  between envelope and cross-frequency alignment are stated as open.
