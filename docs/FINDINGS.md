...
raw 三 seed(重跑,与旧 seed 逐位一致:κ 0.577/0.536/0.495)vs duplex seed 0(κ 0.709),test 29,421 窗,按类 F1:

| 类 | raw F1 | duplex F1 | Δ |
|---|---|---|---|
| GPED(全面周期性放电) | 0.552 | **0.836** | +0.28 |
| PLED(偏侧周期性放电) | 0.517 | **0.665** | +0.15 |
| ARTF | 0.398 | 0.557 | +0.16 |
| BCKG | 0.884 | 0.920 | +0.04 |
| EYEM(眼动) | 0.566 | 0.315 | −0.25 |
...
duplex seed 1/2(存分数)已投 amd 以确认。
