...
|---|---|---|---|---|---|
| LaBraM 5.86M(从零) | 无 | 0.372* → **0.522**(+0.150,09-10 04:40 命中) | 0.406* → 跑 | 0.360* → 跑 | 三格正(CHB-MIT 因宿主训不好) |
| REVE 69.5M(从零) | 无 | native 0.303 → 跑 | native 0.299 → 跑 | — | 两格正(69M 从零训不起来,预训练版 0.685/0.436) |
